...
// thanks to https://github.com/ParaState/simple-staking-smart-contract
...
contract StakingERC20 {
    ...
    function setTimestamp(uint256 _timePeriodInSeconds) public onlyOwner timestampNotSet {
        ...
        bool b;
        (b, timePeriod) = initialTimestamp.tryAdd(_timePeriodInSeconds);
    }
    ...
    function unstakeTokens(IERC20 token, uint256 amount) public timestampIsSet noReentrant {
        ...
        if (block.timestamp >= timePeriod) {
            ...
            (b, balances[msg.sender]) = balances[msg.sender].trySub(amount);
